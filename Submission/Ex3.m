...
Qposition = [200 200 9000]; 
Qvelocity = [0.1 0.1 0.1];
Qangle    = [850 850 50];
Qangveloc = [1 1 1];
% when payload is attached, the following can be uncommented
% Qposition = [50 50 800000]; 
% Qvelocity = [0.1 0.1 0.1];
% Qangle    = [10 10 10];
% Qangveloc = [1 1 1];
